...
Pulitzer.Prize.Change <- mutate(pulitzer, diff = Pulitzer.Prize.Winners.and.Finalists..2004.2014 - Pulitzer.Prize.Winners.and.Finalists..1990.2003)
...
most.2004.2014 <- filter(pulitzers)
